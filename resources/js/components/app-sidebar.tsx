...
export function AppSidebar() {
    ...
    if (authUser?.employee_id == 25052 || authUser?.employee_id == 15012 || authUser?.employee_id == 21023 || authUser?.employee_id == 15231) {
        mainNavItems.push(
            { title: 'All Departments', href: '/departments', category: 'Attendance', icon: Logs },
            { title: 'Late Summary Report', href: '/late-summary-report', category: 'Attendance', icon: Logs },
        );
    ...
    if (authUser?.employee_id == 23033 || authUser?.employee_id == 25052 || authUser?.employee_id == 15012 || authUser?.employee_id == 21023) {
        mainNavItems.push({
    ...
    const groupedNav = navItemsWithKeys.reduce(
        (acc, item) => {
